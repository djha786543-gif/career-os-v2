...
const s: Record<string, React.CSSProperties> = {
  ...
  aiBtn: { background: 'rgba(0,0,0,0.04)', border: '1px solid rgba(0,0,0,0.09)', borderRadius: 6, padding: '6px 12px', color: '#44403C', fontSize: 10, fontWeight: 700, cursor: 'pointer' },
  ...
  aiContent: { fontSize: 13, lineHeight: '1.6', color: '#1C1917', whiteSpace: 'pre-wrap' },
  ...
  scoreBarBg: { height: 4, background: 'rgba(0,0,0,0.07)', borderRadius: 2, overflow: 'hidden' },
  ...
  tierBadge: { width: 24, height: 24, borderRadius: 4, background: 'rgba(0,0,0,0.06)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 10, fontWeight: 900, color: 'var(--accent-active)' },
